...
export type PageRoute = 
  ...
  | 'PROCUREMENT' | 'PROCUREMENT_DETAIL'
  | 'COMPLAINT'
  | 'ABOUT'
  | 'CONTACT';
...
const App: React.FC = () => {
  ...
  const renderPage = () => {
    switch (route) {
      ...
      case 'KNOWLEDGE': return <KnowledgeListPage onNavigate={navigate} />;
      
      case 'NEWS': return <NewsListPage onNavigate={navigate} />;
      case 'NEWS_DETAIL': return <NewsDetailPage id={detailId} onNavigate={navigate} />;
      
      case 'ACTIVITY': return <ActivityListPage onNavigate={navigate} />;
      case 'ACTIVITY_DETAIL': return <ActivityDetailPage id={detailId} onNavigate={navigate} />;
      
      case 'CAREER': return <CareerListPage onNavigate={navigate} />;
      case 'CAREER_DETAIL': return <CareerDetailPage id={detailId} onNavigate={navigate} />;
      
      case 'PROCUREMENT': return <ProcurementListPage onNavigate={navigate} />;
      case 'PROCUREMENT_DETAIL': return <ProcurementDetailPage id={detailId} onNavigate={navigate} />;
      
      case 'COMPLAINT': return <ComplaintPage onNavigate={navigate} />;
